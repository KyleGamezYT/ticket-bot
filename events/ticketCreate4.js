...
if(!interaction.isButton() && !interaction.isSelectMenu()) return;
      ...
      if(interaction.customId == `create_ticket${s}`) {
        ...
        .setAuthor(`Ticket for: ${interaction.user.tag}`, interaction.user.displayAvatarURL(), `https://bobeebeatz.ml/`)
  ...
  .setRequired(false) // If it's required or not
    ...
    showModal(modal, {
      ...
      interaction: interaction // Show the modal with interaction data.
        ...
        .setFooter(`Ticketing byKyleGamezYT\n🔷 On Shard: ${interaction.guild.shardId}`, interaction.guild.iconURL())
        ...
        const embed2 = new MessageEmbed()
        .setColor(client.config.color.main)
        .setAuthor(`${interaction.user.tag} ⚡ Staff Member`, interaction.user.displayAvatarURL(), `KyleGamezYT`)
